...
/**************************************************************************/
/*! 
    @brief  Sets register reg to value val
*/
/**************************************************************************/
void Adafruit_L3GD20_Unified::setRegister(gyroRegisters_t reg, uint8_t val) {
	write8(reg, val);
}
...
*/
/**************************************************************************/
uint8_t Adafruit_L3GD20_Unified::getRegister(gyroRegisters_t reg) {
	return read8(reg);
}

/**************************************************************************/
/*! 
    @brief  Sets the data update rate
*/
/**************************************************************************/
void Adafruit_L3GD20_Unified::setSpeed(gyroSpeed_t speed) {
	uint8_t regVal;
	
	// Read in the existing value to preserve the rest of the settings
	regVal = read8(GYRO_REGISTER_CTRL_REG1);
	// Mask out the non-speed settings & set the speed as commanded
	regVal &= 0x0f;	
	regVal |= speed << 4;
	write8(GYRO_REGISTER_CTRL_REG1, regVal);
}

/**************************************************************************/
/*! 
    @brief  Gets the data update rate
*/
/**************************************************************************/
gyroSpeed_t Adafruit_L3GD20_Unified::getSpeed(void) {
	uint8_t regVal;
	regVal = read8(GYRO_REGISTER_CTRL_REG1);
	return (gyroSpeed_t)((regVal >> 4) & 0x0f);
}
